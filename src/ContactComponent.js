...
class DisplayComponent extends React.Component {
  ...
  formEdit = (selectedItem) => {
    console.log("edit")
    var modal = document.getElementById("myModal");
    modal.style.display = "block";
    //this.setState({ name: this.state.name, email: this.state.email, note: this.state.note, phone: this.state.phone });
    ...
    document.getElementById("note").value = selectedItem.note;
    this.setState({ name: this.state.name, email: this.state.email, note: this.state.note, phone: this.state.phone });
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        <center>
          {console.log("contact",this.state.contactList)}
